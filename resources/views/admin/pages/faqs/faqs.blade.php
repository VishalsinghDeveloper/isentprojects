                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-end">
                                            <a class="edit" href="{{ route('faqs-edit',$faqs->id) }}" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                            <a class="delete" href="{{ route('faqs-destroy',$faqs->id) }}" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
