...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            ...
            <form class="forms-sample" id="myForm" method="POST" action="{{ route('policies-store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" id='tinyMceExample' name="description" placeholder="Edit your content here..."></textarea>
                    @error('description')
                    <span>
                        <div class="text-danger small">{{ $message }}</div>
                    </span>
